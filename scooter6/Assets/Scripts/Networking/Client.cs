...
public class Clientdrölfzig : NetworkSystem
{
    UNetClient _client;
    ...
    public Clientdrölfzig(LevelManager lvlManager, PlayerSystem playerSys, AICarSyncSystem aiCarSystem, WorldLogger logger, WorldLogger fixedLogger)
    {
